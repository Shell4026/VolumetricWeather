...
public:
	...
	static auto GenerateWorleyNoiseTexture(uint32_t width, uint32_t height, uint32_t depth, float f0, float f1, float f2) -> Texel;
...
private:
	...
	static auto WorleyNoiseFBM(const glm::vec3& pIn, float f0, float f1, float f2) -> float;
